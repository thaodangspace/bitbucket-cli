...
var capabilityRegistry = map[string]Capability{
	...
	"webhook.read":            {Operation: "webhook.read", AuthKinds: []string{"api", "access", "oauth"}, Scopes: []string{"read:repository:bitbucket"}, Available: true, Note: "Webhook reads use the repository/workspace webhook API."},
	"webhook.write":           {Operation: "webhook.write", AuthKinds: []string{"api", "access", "oauth"}, Scopes: []string{"admin:repository:bitbucket"}, Available: true, Note: "Webhook mutations require repository administration."},
	...
	"deploy-key.read":         {Operation: "deploy-key.read", AuthKinds: []string{"api", "access", "oauth"}, Scopes: []string{"read:ssh-key:bitbucket", "read:repository:bitbucket"}, Available: true, Note: "Deploy keys are repository-scoped and read-only for Git access."},
